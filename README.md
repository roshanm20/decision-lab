...
I am Muhammed Roshan M. I co-founded [Nayrix](https://nayrix.com) and built [CompEdge](https://compedge.nayrix.com), an AI competitive intelligence product. Before that I did a BS-MS in Physics at IISER Bhopal and research at EPFL. I am preparing for a PGP at an IIM, and this repo is where I work through the kind of problems that job involves, in public, one piece a day.
...
| [`content/cases`](content/cases) | Management case notes. A decision, the options with numbers, my call |
...
Being open about the automation is deliberate. Using a tool well and keeping a standard it has to meet is the skill worth showing. The standards file is the interesting file, not the commit count.
